...
class InstallForm(forms.Form): 
    netbox_hostname = forms.CharField(max_length=80, initial='143.54.235.23')
    netbox_port = forms.IntegerField(initial=8080)
    ...
    prefix4 = forms.CharField(max_length=120, initial='143.54.234.0/23')
    ...
    device_address4 = forms.CharField(max_length=120, initial='143.54.235.6/23')
